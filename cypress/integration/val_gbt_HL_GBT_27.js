...
context('Kiểm thử HL-GBT_27', function(){
  before(function(){
  ...
  it('HL-GBT_27 - 1: Nhập vào ô số lần làm bài', function(){
    var i = 1.0
    cy.log('--------số thực'+ i)
  ...
  it('HL-GBT_27 - 2: Nhập vào ô số lần làm bài', function(){
    cy.wait(5000)
    var i = 1.1
    cy.log('--------số thực '+ i)
    cy.get(':nth-child(7) > .form-control').clear().type(i).should('have.value',i.toString())
  ...
  it('HL-GBT_27 - 3: Nhập vào ô số lần làm bài', function(){
    cy.wait(5000)
    var i = 10.1
    cy.log('--------số thực '+ i)
    cy.get(':nth-child(7) > .form-control').clear().type(i).should('have.value',i.toString())
  ...
  it('HL-GBT_27 - 4: Nhập vào ô số lần làm bài', function(){
    cy.wait(5000)
    var i = 100.9
    cy.log('--------số thực '+ i)
    cy.get(':nth-child(7) > .form-control').clear().type(i).should('have.value',i.toString())
